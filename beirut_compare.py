...
train_loss = np.load('results/beirut_comparison/beirut_gcn_loss_train.npy')
test_loss = np.load('results/beirut_comparison/beirut_gcn_loss_test.npy')
train_acc = np.load('results/beirut_comparison/beirut_gcn_acc_train.npy')
test_acc = np.load('results/beirut_comparison/beirut_gcn_acc_test.npy')
train_precision = np.load('results/beirut_comparison/beirut_gcn_prec_train.npy')
test_precision = np.load('results/beirut_comparison/beirut_gcn_prec_test.npy')
train_recall = np.load('results/beirut_comparison/beirut_gcn_rec_train.npy')
test_recall = np.load('results/beirut_comparison/beirut_gcn_rec_test.npy')
train_specificity = np.load('results/beirut_comparison/beirut_gcn_spec_train.npy')
test_specificity = np.load('results/beirut_comparison/beirut_gcn_spec_test.npy')
train_f1 = np.load('results/beirut_comparison/beirut_gcn_f1_train.npy')
test_f1 = np.load('results/beirut_comparison/beirut_gcn_f1_test.npy')

train_loss_meta = np.load('results/beirut_comparison/beirut_gcn_meta_loss_train.npy')
test_loss_meta = np.load('results/beirut_comparison/beirut_gcn_meta_loss_test.npy')
train_acc_meta = np.load('results/beirut_comparison/beirut_gcn_meta_acc_train.npy')
test_acc_meta = np.load('results/beirut_comparison/beirut_gcn_meta_acc_test.npy')
train_precision_meta = np.load('results/beirut_comparison/beirut_gcn_meta_prec_train.npy')
test_precision_meta = np.load('results/beirut_comparison/beirut_gcn_meta_prec_test.npy')
train_recall_meta = np.load('results/beirut_comparison/beirut_gcn_meta_rec_train.npy')
test_recall_meta = np.load('results/beirut_comparison/beirut_gcn_meta_rec_test.npy')
train_specificity_meta = np.load('results/beirut_comparison/beirut_gcn_meta_spec_train.npy')
test_specificity_meta = np.load('results/beirut_comparison/beirut_gcn_meta_spec_test.npy')
train_f1_meta = np.load('results/beirut_comparison/beirut_gcn_meta_f1_train.npy')
test_f1_meta = np.load('results/beirut_comparison/beirut_gcn_meta_f1_test.npy')
