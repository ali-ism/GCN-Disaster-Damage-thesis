...
if __name__ == "__main__":
    ...
    fig.add_trace(go.Scatter(y=hold_loss_meta, name='hold_meta', legendgroup='hold_meta', line=dict(color='yellow')), row=1, col=1)

    fig.add_trace(go.Scatter(y=train_acc, name='train', legendgroup='train', line=dict(color='blue')), row=1, col=2)
    fig.add_trace(go.Scatter(y=test_acc, name='test', legendgroup='test', line=dict(color='orange')), row=1, col=2)
    fig.add_trace(go.Scatter(y=hold_acc, name='hold', legendgroup='hold', line=dict(color='purple')), row=1, col=2)
    fig.add_trace(go.Scatter(y=train_acc_meta, name='train_meta', legendgroup='train_meta', line=dict(color='green')), row=1, col=2)
    fig.add_trace(go.Scatter(y=test_acc_meta, name='test_meta', legendgroup='test_meta', line=dict(color='red')), row=1, col=2)
    fig.add_trace(go.Scatter(y=hold_acc_meta, name='hold_meta', legendgroup='hold_meta', line=dict(color='yellow')), row=1, col=2)    

    fig.add_trace(go.Scatter(y=train_precision, name='train', legendgroup='train', line=dict(color='blue')), row=1, col=3)
    fig.add_trace(go.Scatter(y=test_precision, name='test', legendgroup='test', line=dict(color='orange')), row=1, col=3)
    fig.add_trace(go.Scatter(y=hold_precision, name='hold', legendgroup='hold', line=dict(color='purple')), row=1, col=3)
    fig.add_trace(go.Scatter(y=train_precision_meta, name='train_meta', legendgroup='train_meta', line=dict(color='green')), row=1, col=3)
    fig.add_trace(go.Scatter(y=test_precision_meta, name='test_meta', legendgroup='test_meta', line=dict(color='red')), row=1, col=3)
    fig.add_trace(go.Scatter(y=hold_precision_meta, name='hold_meta', legendgroup='hold_meta', line=dict(color='yellow')), row=1, col=3)

    fig.add_trace(go.Scatter(y=train_recall, name='train', legendgroup='train', line=dict(color='blue')), row=2, col=1)
    fig.add_trace(go.Scatter(y=test_recall, name='test', legendgroup='test', line=dict(color='orange')), row=2, col=1)
    fig.add_trace(go.Scatter(y=hold_recall, name='hold', legendgroup='hold', line=dict(color='purple')), row=2, col=1)
    fig.add_trace(go.Scatter(y=train_recall_meta, name='train_meta', legendgroup='train_meta', line=dict(color='green')), row=2, col=1)
    fig.add_trace(go.Scatter(y=test_recall_meta, name='test_meta', legendgroup='test_meta', line=dict(color='red')), row=2, col=1)
    fig.add_trace(go.Scatter(y=hold_recall_meta, name='hold_meta', legendgroup='hold_meta', line=dict(color='yellow')), row=2, col=1)

    fig.add_trace(go.Scatter(y=train_specificity, name='train', legendgroup='train', line=dict(color='blue')), row=2, col=2)
    fig.add_trace(go.Scatter(y=test_specificity, name='test', legendgroup='test', line=dict(color='orange')), row=2, col=2)
    fig.add_trace(go.Scatter(y=hold_specificity, name='hold', legendgroup='hold', line=dict(color='purple')), row=2, col=2)
    fig.add_trace(go.Scatter(y=train_specificity_meta, name='train_meta', legendgroup='train_meta', line=dict(color='green')), row=1, col=1)
    fig.add_trace(go.Scatter(y=test_specificity_meta, name='test_meta', legendgroup='test_meta', line=dict(color='red')), row=2, col=2)
    fig.add_trace(go.Scatter(y=hold_specificity_meta, name='hold_meta', legendgroup='hold_meta', line=dict(color='yellow')), row=2, col=2)

    fig.add_trace(go.Scatter(y=train_f1, name='train', legendgroup='train', line=dict(color='blue')), row=2, col=3)
    fig.add_trace(go.Scatter(y=test_f1, name='test', legendgroup='test', line=dict(color='orange')), row=2, col=3)
    fig.add_trace(go.Scatter(y=hold_f1, name='hold', legendgroup='hold', line=dict(color='purple')), row=2, col=3)
    fig.add_trace(go.Scatter(y=train_f1_meta, name='train_meta', legendgroup='train_meta', line=dict(color='green')), row=2, col=3)
    fig.add_trace(go.Scatter(y=test_f1_meta, name='test_meta', legendgroup='test_meta', line=dict(color='red')), row=2, col=3)
    fig.add_trace(go.Scatter(y=hold_f1_meta, name='hold_meta', legendgroup='hold_meta', line=dict(color='yellow')), row=2, col=3)
