...
np.save('results/Sensitivity GCN AE/ae_acc_sens.npy', accuracy)
np.save('results/Sensitivity GCN AE/ae_prec_sens.npy', precision)
np.save('results/Sensitivity GCN AE/ae_rec_sens.npy', recall)
np.save('results/Sensitivity GCN AE/ae_spec_sens.npy', specificity)
np.save('results/Sensitivity GCN AE/ae_f1_sens.npy', f1)